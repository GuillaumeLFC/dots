...
wofi_command = f"echo '{output}' | wofi -s ~/.config/wofi/nosearch.css --show=dmenu --hide-scroll --allow-markup --define=hide_search=true --location=top_right --width=600 --height=100 --xoffset=-60"
