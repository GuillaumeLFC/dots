...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "University of Nantes"
Config.profilename = "Students UN"
Config.url = "http://eduroam.univ-nantes.fr"
Config.email = "support-eduroam@univ-nantes.fr"
Config.title = "eduroam CAT"
Config.server_match = "etu.univ-nantes.fr"
...
Config.user_realm = "etu.univ-nantes.fr"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:rad.etu.univ-nantes.fr', 'DNS:radius.etu.univ-nantes.fr']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@etu.univ-nantes.fr"
